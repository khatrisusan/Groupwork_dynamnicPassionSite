...
const Fetch = "11uCM4X1aMt_7X0s6qUkZyXIoopkTqrTyISDarVU6kQ0";
...
function showSheet(data) {
    ...
    if (data.gsx$dishtitle.$t == id) {
        //console.log("yes");
        cloneData.querySelector("img.dishimg").src =
            "image/" + data.gsx$imagename.$t;
        cloneData.querySelector("h1.dish-title").textContent =
            data.gsx$dishtitle.$t;
        cloneData.querySelector("p.noun").textContent = data.gsx$noun.$t;
        cloneData.querySelector("p.recipe").textContent = data.gsx$recipe.$t;
        cloneData.querySelector(
            "p.author"
        ).textContent = `Outfit Credit: ${data.gsx$author.$t}`;
        ...
        cloneData.querySelector("p.dish-description").textContent =
            data.gsx$dishdescription.$t;
        cloneData.querySelector("p.description1").textContent =
            data.gsx$outfitdescription1.$t;
        cloneData.querySelector("p.description2").textContent =
            data.gsx$outfitdescription2.$t;
        cloneData.querySelector("p.description3").textContent =
            data.gsx$outfitdescription3.$t;
        cloneData.querySelector("img.img1").src =
            "image/" + data.gsx$fashionimage1.$t;
        cloneData.querySelector("img.img2").src =
            "image/" + data.gsx$fashionimage2.$t;
        cloneData.querySelector("img.img3").src =
            "image/" + data.gsx$fashionimage3.$t;
        //data.gsx$outfitdescription3.$t;
        ...
        cloneData
            .querySelector("button.ratingone")
            .addEventListener("click", () => {
                modal.classList.remove("hide");
                document.querySelector("p.rating").textContent =
                    data.gsx$rating1.$t;
            });
        cloneData
            .querySelector("button.ratingtwo")
            .addEventListener("click", () => {
                modal.classList.remove("hide");
                document.querySelector("p.rating").textContent =
                    data.gsx$rating2.$t;
        ...
        cloneData
            .querySelector("button.ratingthree")
            .addEventListener("click", () => {
                modal.classList.remove("hide");
                document.querySelector("p.rating").textContent =
                    data.gsx$rating3.$t;
